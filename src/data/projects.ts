...
export const projects: Project[] = [
  {
    title: "PARC",
    subtitle: "European Partnership for the Assessment of Risks from Chemicals",
    description:
    ...
    status: "active",
    date: "2021",
    grantNumber: "101057014",
    funding: "EU Horizon Europe",
  },
  {
    title: "MERLON",
    subtitle: "Merging scientific evidence with regulatory practices and leveraging identification of endocrine disruptors using new approach methodologies",
    description:
  ...
  {
    title: "ENVESOME",
    subtitle: "Environmental health and exposome research initiative",
    description:
      "ENVESOME is a groundbreaking 4-year research initiative funded under the H2020 program, dedicated to elucidating mechanistically the role of air, noise, light, and hazardous waste pollution in non-communicable diseases by developing an exposome and citizen-science-based framework. Our innovative methodology fuses environmental monitoring, personal exposure data, and AI-driven models with insights from human biomonitoring, and in vitro studies. This will allow us to uncover the adverse outcome pathways and networks triggered by environmental stressors, offering a deeper mechanistic understanding of their impact. Through cutting-edge research and citizen science participation, ENVESOME is shaping a new paradigm in environmental health—empowering communities and policymakers with actionable knowledge to mitigate emerging environmental risks.",
    status: "active",
    date: "2024",
    funding: "Horizon 2020",
    website: "https://envesome.eu/",
  },
  {
    title: "FlameRISK",
    subtitle: "Sources, exposure and health risk to legacy and emerging Flame retardants in Spanish indoor environments",
    description:
    ...
    status: "past",
    date: "2019",
    grantNumber: "RTI2018-095466-B-I00",
    funding: "Spanish Ministry of Science and Innovation",
  },
  {
    title: "HBM4EU",
    subtitle: "Human Biomonitoring for Europe",
    description:
  ...
  {
    title: "NEUROSOME",
    subtitle: "A Multidisciplinary Training Network To Explore The Neurodevelopmental And Neurological Exposome",
    description:
  ...
  {
    title: "EarlyFOOD",
    subtitle: "Long-term impact of gestational and early-life dietary habits on infant gut immunity and disease risk",
    description:
    ...
    status: "past",
    date: "2018",
    grantNumber: "PCIN-2017-012",
    funding: "JPI HDHL",
  },
  {
    title: "EUROMIX",
    subtitle: "European Test and Risk Assessment Strategies For Mixtures",
    description:
  ...
  {
    title: "HEALS",
    subtitle: "Health and Environment-wide Associations based on Large population Surveys",
    description:
